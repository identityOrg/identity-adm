...
export const CreateFormConfig = [
  new EditControl({name: 'username', label: 'Username', type: 'text', groupName: 'general'}),
  new EditControl({name: 'locked', label: 'Locked', type: 'yes-no', groupName: 'none'}),
  new EditControl({name: 'active', label: 'Active', type: 'yes-no', groupName: 'none'}),
  new EditControl({name: 'admin', label: 'Admin', type: 'yes-no', groupName: 'none'}),
